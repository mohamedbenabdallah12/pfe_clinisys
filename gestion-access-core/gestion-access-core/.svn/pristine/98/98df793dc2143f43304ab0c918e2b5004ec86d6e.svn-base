...
public class WhereClauseBuilder implements Predicate, Cloneable {
    ...
    public WhereClauseBuilder andAnyOf(Predicate... right) {
        return new WhereClauseBuilder(delegate.andAnyOf(right));
    }

    public WhereClauseBuilder orAllOf(Predicate... right) {
        return new WhereClauseBuilder(delegate.orAllOf(right));
    }
